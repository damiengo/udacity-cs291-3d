...
function createDrinkingBird() {
        ...
        crossbar.rotation.z = 90 * Math.PI / 180;
        crossbar.rotation.y = 90 * Math.PI / 180;
        ...
        var eye1 = new THREE.Mesh(
                new THREE.SphereGeometry( 10, 32, 16 ), eyeMaterial );
        eye1.position.x = -48;
        eye1.position.y = 560;
        var eyes1 = new THREE.Object3D();
        eyes1.add(eye1);
        eyes1.rotation.y = 20 * Math.PI / 180;
        var eye2 = new THREE.Mesh(
                new THREE.SphereGeometry( 10, 32, 16 ), eyeMaterial );
        eye2.position.x = -48;
        eye2.position.y = 560;
        var eyes2 = new THREE.Object3D();
        eyes2.add(eye2);
        eyes2.rotation.y = - 20 * Math.PI / 180;
        scene.add(eyes1);
        scene.add(eyes2);
}
